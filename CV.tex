...
\item Established, socialized, and enforced (with CI and GitHub Status Checks) coding guidelines and team norms
...
\item Graduate teaching assistant for Geography Department’s undergraduate Introduction to Remote Sensing course
  \begin{mitemize}
    ...
    \item Selected software (IDL/ENVI) and text and negotiated purchase for lab
\end{mitemize}
...
\item O'Reilly JupyterCon \href{https://conferences.oreilly.com/jupyter/jup-ny}{New York 2018}
  ...
  \item WhereCamp
    \begin{mitemize}
    \item \href{http://gisuser.com/2011/12/wherecamptb-ignitespatial-feb-10-11-tampa-fl/}{WhereCampTB + IgniteSpatial 2012}
    \item \href{https://conferences.oreilly.com/where/where2010/public/schedule/detail/14268}{Mountain View 2010}
    \end{mitemize}
\end{mitemize}
