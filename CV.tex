...
\myitemL{Google} \hfill October 2023--present

\myitem{Google Cloud Security Adoption Engineer}

\begin{mitemize}
\item Full Stack Web Development for Cyber Threat Intelligence Appliance (Soltra Edge)
\begin{mitemize}
  \item Establish and maintain relationships with product and engineering teams, serving as the advocate of the practitioner and assisting in guiding new features as they come to market.
  \item Operationalize cyber threat intelligence (CTI) and security operations using SIEM and SOAR.
  \item Assist with the technical enablement of internal teams such as customer success, professional services, and technical sales.
  \item Assist with strategic escalations from customers, prospects, and partners.
  \item Assist with the technical enablement of internal teams such as customer success, professional services, and technical sales.
  \item Create, own, and maintain custom and repeatable technical solutions
  \item Use Subject Matter Expertise to influence and improve technical solutions
\end{mitemize}
\end{mitemize}

\myitemL{Soltra (DTCC/NC4/Celerium)} \hfill November 2014--October 2023
