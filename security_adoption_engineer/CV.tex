...
\vspace{\baselineskip}
\begin{sloppypar}
\myitem{Software Engineer:} Golang, Python, Shell scripting (Bash, Make), Interactive Data Language (IDL), Fortran, Perl, Node.js, C/C++, CPU/Memory Line Profiling, Query Tuning
...
\myitemL{Soltra (DTCC/NC4/Celerium/Dark Cubed)} \hfill November 2014--present

\myitem{Senior/Consulting Software Engineer}

\begin{mitemize}
  \item Lead Engineer for Intrusion Detection/Prevention SaaS (Dark Cubed)
  \begin{mitemize}
    \item Golang, Kafka, Elasticsearch, Redis, on Kubernetes
  \end{mitemize}
  \end{mitemize}
